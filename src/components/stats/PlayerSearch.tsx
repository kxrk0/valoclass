      ...
      <div className="card">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={t.stats.playerSearch.placeholder}
          ...
          >
            {loading ? (
              ...
              <>
            <Search size={18} />
            {t.stats.playerSearch.searchButton}
              </>
            )}
          </button>
        </form>
        ...
        {recentSearches.length > 0 && !playerStats && (
          <div className="mt-6 pt-6 border-t border-gray-700">
            <h3 className="text-sm font-medium text-gray-300 mb-3">{t.stats.playerSearch.popularSearches}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="card">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold">{t.stats.playerSearch.tips.trackProgress.title}</h3>
            </div>
            <p className="text-gray-400 text-sm">
              {t.stats.playerSearch.tips.trackProgress.description}
            </p>
          </div>
          ...
          <div className="card">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold">{t.stats.playerSearch.tips.compareWithFriends.title}</h3>
            </div>
            <p className="text-gray-400 text-sm">
              {t.stats.playerSearch.tips.compareWithFriends.description}
            </p>
          </div>
        </div>
      )}
